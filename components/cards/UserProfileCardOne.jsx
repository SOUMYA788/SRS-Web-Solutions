...
export const UserProfileCardOne = ({ user, cardWidth }) => {
    return (
        <div className={`w-full ${cardWidth ? "md:w-full" : 'md:w-[300px]'} h-fit px-2 py-5  bg-slate-200 dark:bg-slate-800 bg-opacity-60 dark:bg-opacity-80 border-slate-400 shadow-md border-2 rounded-lg relative flex flex-col items-center`}>
