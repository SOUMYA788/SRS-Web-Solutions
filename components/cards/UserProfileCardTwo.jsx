...
export const UserProfileCardTwo = ({ user, cardWidth }) => {
    ...
    return (
        <div className={`${cardWidth || "w-full"} h-[250px] flex flex-col justify-end items-center ${user?.userProfileBackgroundColor} dark:border-2 dark:border-slate-400 rounded-lg relative`}>
            {
